...
#define WordObs \
"./data/vqa/factory/word_obs.txt"

#define HasImgObs \
"./data/vqa/factory/hasimg_obs.txt"

#define HasQObs \
"./data/vqa/factory/hasq_obs.txt"

#define SimObs \
"./data/vqa/factory/sim_obs.txt"

#define AnsTar \
"./data/vqa/factory/ans_target.txt"
