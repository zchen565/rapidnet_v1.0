...
#define WordObs \
"./data/vqa/stadium/word_obs.txt"

#define HasImgObs \
"./data/vqa/stadium/hasimg_obs.txt"

#define HasQObs \
"./data/vqa/stadium/hasq_obs.txt"

#define SimObs \
"./data/vqa/stadium/sim_obs.txt"

#define AnsTar \
"./data/vqa/stadium/ans_target.txt"
