...
#define WordObs \
"./data/vqa/station/word_obs.txt"

#define HasImgObs \
"./data/vqa/station/hasimg_obs.txt"

#define HasQObs \
"./data/vqa/station/hasq_obs.txt"

#define SimObs \
"./data/vqa/station/sim_obs.txt"

#define AnsTar \
"./data/vqa/station/ans_target.txt"
