...
#define WordObs \
"./data/vqa/terminal/word_obs.txt"

#define HasImgObs \
"./data/vqa/terminal/hasimg_obs.txt"

#define HasQObs \
"./data/vqa/terminal/hasq_obs.txt"

#define SimObs \
"./data/vqa/terminal/sim_obs.txt"

#define AnsTar \
"./data/vqa/terminal/ans_target.txt"
