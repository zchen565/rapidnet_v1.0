...
#include "ns3/secure-pingpong-module.h"
#include "ns3/rapidnet-module.h"
#include "ns3/values-module.h"

#define tlink(src, next)                      \
  rtuple(SecurePingpong::TLINK,               \
...
{
  LogComponentEnable("SecurePingpong", LOG_LEVEL_INFO);
  LogComponentEnable("RapidNetApplicationBase", LOG_LEVEL_INFO);

  apps = InitRapidNetApps(2, Create<SecurePingpongHelper>());
