...
using namespace ns3::rapidnet::simlsperiodic;

const string SimLsPeriodic::ELSU = "eLSU";
const string SimLsPeriodic::ELSUCHANGE = "eLSUChange";
const string SimLsPeriodic::ELSUCOUNT = "eLSUCount";
const string SimLsPeriodic::ELSULOC = "eLSULoc";
const string SimLsPeriodic::ELINKADD = "eLinkAdd";
const string SimLsPeriodic::ELINKCOUNT = "eLinkCount";
const string SimLsPeriodic::LINK = "link";
const string SimLsPeriodic::PERIODIC = "periodic";
const string SimLsPeriodic::R11_ECAPERIODIC = "r11_ecaperiodic";
const string SimLsPeriodic::R12_ECAPERIODIC = "r12_ecaperiodic";
const string SimLsPeriodic::TLSU = "tLSU";
const string SimLsPeriodic::TLINK = "tLink";

NS_LOG_COMPONENT_DEFINE("SimLsPeriodic");
NS_OBJECT_ENSURE_REGISTERED(SimLsPeriodic);

TypeId
SimLsPeriodic::GetTypeId(void)
{
  static TypeId tid = TypeId("ns3::rapidnet::simlsperiodic::SimLsPeriodic")
                          .SetParent<Discovery>()
                          .AddConstructor<SimLsPeriodic>();
  return tid;
}

SimLsPeriodic::SimLsPeriodic()
{
...
void SimLsPeriodic::DoDispose(void)
{
  NS_LOG_FUNCTION_NOARGS();
...
void SimLsPeriodic::StartApplication(void)
{
  NS_LOG_FUNCTION_NOARGS();

  Discovery::StartApplication();
  m_event_r11_ecaperiodic =
      Simulator::Schedule(Seconds(60 + (drand48() * 1)), &SimLsPeriodic::R11_ecaperiodic, this);
  m_event_r12_ecaperiodic =
      Simulator::Schedule(Seconds(59), &SimLsPeriodic::R12_ecaperiodic, this);
  RAPIDNET_LOG_INFO("SimLsPeriodic Application Started");
}

void SimLsPeriodic::StopApplication()
{
  NS_LOG_FUNCTION_NOARGS();
  ...
  RAPIDNET_LOG_INFO("SimLsPeriodic Application Stopped");
}

void SimLsPeriodic::InitDatabase()
{
...
void SimLsPeriodic::DemuxRecv(Ptr<Tuple> tuple)
{
...
void SimLsPeriodic::R01Eca0Ins(Ptr<Tuple> link)
{
...
void SimLsPeriodic::R01Eca0Ref(Ptr<Tuple> link)
{
...
void SimLsPeriodic::R02_eca(Ptr<Tuple> eLinkAdd)
{
...
void SimLsPeriodic::R03_eca(Ptr<Tuple> eLinkCount)
{
...
void SimLsPeriodic::R04_eca(Ptr<Tuple> eLinkAdd)
{
...
void SimLsPeriodic::R11_ecaperiodic()
{
  ...
  m_event_r11_ecaperiodic = Simulator::Schedule(Seconds(60),
                                                &SimLsPeriodic::R11_ecaperiodic, this);
}

void SimLsPeriodic::R11_eca(Ptr<Tuple> r11_ecaperiodic)
{
...
void SimLsPeriodic::R12_ecaperiodic()
{
  ...
  m_event_r12_ecaperiodic = Simulator::Schedule(Seconds(60),
                                                &SimLsPeriodic::R12_ecaperiodic, this);
}

void SimLsPeriodic::R12_eca(Ptr<Tuple> r12_ecaperiodic)
{
...
void SimLsPeriodic::R21_eca(Ptr<Tuple> eLSU)
{
...
void SimLsPeriodic::R22_eca(Ptr<Tuple> eLSULoc)
{
...
void SimLsPeriodic::R23_eca(Ptr<Tuple> eLSUCount)
{
...
void SimLsPeriodic::R24_eca(Ptr<Tuple> eLSULoc)
{
...
void SimLsPeriodic::R31Eca0Ins(Ptr<Tuple> tLSU)
{
...
void SimLsPeriodic::R31Eca0Ref(Ptr<Tuple> tLSU)
{
...
void SimLsPeriodic::R32_eca(Ptr<Tuple> eLSUChange)
{
