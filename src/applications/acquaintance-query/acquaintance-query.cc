...
void AcquaintanceQuery::DoDispose(void)
{
  NS_LOG_FUNCTION_NOARGS();
...
void AcquaintanceQuery::StartApplication(void)
{
  NS_LOG_FUNCTION_NOARGS();
...
void AcquaintanceQuery::StopApplication()
{
  NS_LOG_FUNCTION_NOARGS();
...
void AcquaintanceQuery::InitDatabase()
{
...
void AcquaintanceQuery::DemuxRecv(Ptr<Tuple> tuple)
{
...
void AcquaintanceQuery::Q1_ecaperiodic()
{
...
void AcquaintanceQuery::Q1_eca(Ptr<Tuple> q1_ecaperiodic)
{
...
void AcquaintanceQuery::Q2_eca(Ptr<Tuple> pReturn)
{
