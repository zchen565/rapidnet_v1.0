...
void MincostQuery::DoDispose(void)
{
  NS_LOG_FUNCTION_NOARGS();
...
void MincostQuery::StartApplication(void)
{
  NS_LOG_FUNCTION_NOARGS();
...
void MincostQuery::StopApplication()
{
  NS_LOG_FUNCTION_NOARGS();
...
void MincostQuery::InitDatabase()
{
...
void MincostQuery::DemuxRecv(Ptr<Tuple> tuple)
{
...
void MincostQuery::Q1_ecaperiodic()
{
...
void MincostQuery::Q1_eca(Ptr<Tuple> q1_ecaperiodic)
{
...
void MincostQuery::Q2_eca(Ptr<Tuple> pReturn)
{
